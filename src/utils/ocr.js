...
// Ensure you add VITE_GEMINI_API_KEY to your .env file
...
/**
 * Extracts data from multiple Files (PDFs or Images) using Gemini.
 * @param {File[]} files The files to process.
 * @param {string} userInstructions Optional instructions on what to extract.
 * @returns {Promise<Object>} A JSON object containing the extracted fields.
 */
export async function extractDataFromDocuments(files, userInstructions = "") {
  if (!genAI) {
    throw new Error("Gemini API key is missing. Please add VITE_GEMINI_API_KEY to your .env file.");
  }

  // Convert Files to base64 and associate with their names
